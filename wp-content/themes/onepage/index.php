...
<div id="page">
	...
	?>
		<?php
             ...
             * Twitter tweets
             */
             if(array_key_exists('twitter',$homepage_layout)) :?>
            <section id="homepage-twitter" class="homepage-section homepage-twitter" style="background-color:<?php echo $mts_options['homepage_twitter_background_color']; ?>;background-image: url(<?php print $mts_options['homepage_twitter_background_image']; ?>); ">
                <div class="inside">
                    <?php
                        ...
                        if(!empty($mts_twitter_plugin_tweets)){
                            print '<div class="mts_recent_tweets tweets">';
                                $fctr = '1';
