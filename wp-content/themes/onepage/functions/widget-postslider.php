...
//		$show_thumb8 = isset( $instance[ 'show_thumb8' ] ) ? intval( $instance[ 'show_thumb8' ] ) : 1;
                                ...
                                <a href="<?php the_permalink() ?>">
                                    ...
                                    <?php if ($show_title) { ?>
                                        <div class="flex-caption">
                                            <h6 class="slidertitle"><?php $title = get_the_title();  echo ($title_limit < 1) ? $title : (strlen($title) > $title_limit ? substr($title, 0, $title_limit).'...' : $title); ?></h6>
                                        </div>
                                    <?php } ?>
                                </a> 
                            </li>
