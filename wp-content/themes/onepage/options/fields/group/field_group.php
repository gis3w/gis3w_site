	...
	function render(){
        ...
        $field_is_title = true;
            foreach ($this->field['subfields'] as $field) {
                ...
                $content = str_replace(' for="'.$field['id'].'_', ' for="'.$field['id'].'_@_', $content);
                $content = str_replace(' id="'.$field['id'].'_', ' id="'.$field['id'].'_@_', $content);
        ...
        foreach ($groups as $k => $group) {
            ...
            foreach ($this->field['subfields'] as $field) {
                ...
                // fix for radio buttons
                $content = str_replace(' for="'.$field['id'].'_', ' for="'.$field['id'].'_'.$x.'_', $content);
                $content = str_replace(' id="'.$field['id'].'_', ' id="'.$field['id'].'_'.$x.'_', $content);
